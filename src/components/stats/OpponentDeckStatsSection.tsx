...
export function OpponentDeckStatsSection({ stats, startDate, endDate, disableNavigation }: { stats: OpponentRow[]; startDate?: string; endDate?: string; disableNavigation?: boolean }) {
